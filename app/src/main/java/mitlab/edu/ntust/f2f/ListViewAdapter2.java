...
public class ListViewAdapter2 extends ArrayAdapter<HashMap<Integer, String>> {
    ...
    public ListViewAdapter2(Activity activity,int textViewResourceId,ArrayList<HashMap<Integer, String>> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.txtFirst =(TextView) convertView.findViewById(R.id.date2);
            holder.txtSecond  =(TextView) convertView.findViewById(R.id.time2);
